...
@Setter
@Embeddable
public class QrtzCronTriggerId implements java.io.Serializable {
    private static final long serialVersionUID = -4102928681105795365L;
    @Size(max = 120)
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        QrtzCronTriggerId entity = (QrtzCronTriggerId) o;
