...
@Setter
@Embeddable
public class QrtzTriggerId implements java.io.Serializable {
    private static final long serialVersionUID = 8518947306165595027L;
    @Size(max = 120)
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        QrtzTriggerId entity = (QrtzTriggerId) o;
